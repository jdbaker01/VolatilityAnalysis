...
def test_with_constraint_set():
    ...
    try:
        ...
        print(f"Error with MinVolatilityStrategy: {str(e)}")
    ...
    try:
        ...
        print(f"Error with MaxSharpeStrategy: {str(e)}")
    ...
    try:
        ...
        print(f"Error with EqualRiskStrategy: {str(e)}")
    ...
    try:
        ...
        print(f"Error with MaxReturnStrategy: {str(e)}")
